...
<div class="nav">
    ...
    <div class="article">
        <div class="main">
            <?php if($art): ?><form action="<?php echo U('alter_article');?>" method="post">
                <input type="hidden" name="id" value="<?php echo ($art["id"]); ?>">
            <?php else: ?>
                <form action="<?php echo U('add_article');?>" method="post"><?php endif; ?>
            ...
            <div class="addBlog">
                ...
                <div class="textDv">
                    <input type="text" class="text_box" name="tags" placeholder="标签" value="<?php echo (implode(',',json_decode($art["tags"]))); ?>">
                </div>
                <div class="textDv">
                    <textarea name="description" class="textarea_box" placeholder="简介"><?php echo ($art["description"]); ?></textarea>
                </div>
                <div class="textDv">
